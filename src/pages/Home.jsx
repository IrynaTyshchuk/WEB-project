...
function Home() {
  ...
  const confirmDate = () => {
    if (selectedDate) {
      navigate('/cinema-hall', { state: { movie: selectedMovie, date: selectedDate } });
    } else {
  ...
  return (
    <div className="app">
      <header className="header">
        <div className="right">
          Світ кіно
          <svg viewBox="0 0 64 64" width="42" height="42" fill="white" style={{ marginLeft: '10px' }}>
        ...
        <div className="search-and-genres">
          ...
          <div className="genres">
            <span
              ...
              role="button"
              tabIndex={0}
              onKeyDown={e => { if (e.key === 'Enter') setActiveGenre(null); }}
            >
              Всі жанри
            </span>
            {genres.map((genre, index) => (
              <span
                ...
                role="button"
                tabIndex={0}
                onKeyDown={e => { if (e.key === 'Enter') setActiveGenre(activeGenre === genre ? null : genre); }}
              >
                {genre}
              </span>
            ))}
      ...
      <div className="movie-list">
        {filteredMovies.length === 0 && <p>Фільми не знайдені.</p>}
